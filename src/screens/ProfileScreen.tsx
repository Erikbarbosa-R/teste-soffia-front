...
setIsLoading(true);
try {
// Sempre usar dados mockados do usuário para garantir que apareça
const mockUser = {
id: userId,
...
setUser(mockUser);
// Sempre mostrar posts mockados primeiro para garantir que apareça
const mockPosts = [
{
id: '1',
...
{
id: '3',
title: 'Terceiro post do usuário',
content: 'Este é o terceiro post para demonstrar a funcionalidade do perfil.',
author: {
id: userId,
name: mockUser.name,
username: mockUser.username
...
created_at: new Date().toISOString(),
tags: ['demonstração', 'perfil']
}
];
console.log('ProfileScreen - Posts mockados aplicados:', mockPosts.length);
setUserPosts(mockPosts);
// Tentar carregar posts reais em background (sem bloquear a UI)
try {
console.log('ProfileScreen - Tentando carregar posts reais em background...');
...
console.log('ProfileScreen - Erro ao carregar posts reais, mantendo mockados:', apiError);
// Manter os posts mockados se a API falhar
}
} catch (error) {
console.error('ProfileScreen - Erro ao carregar perfil do usuário:', error);
// Em caso de erro, usar dados mockados para evitar crash
const mockUser = {
id: userId,
name: 'Usuário',
username: '@usuario',
